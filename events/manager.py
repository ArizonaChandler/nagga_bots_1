...
from events.templates import get_event_template
...
class EventsManager:
    ...
    def __init__(self):
        self.bot = None
        self.active_sessions = {}  # {session_id: {'channel_id', 'creator_id', 'template_id', 'collect_time', ...}}
    ...
    def create_session(self, creator_id: str, template_id: int, collect_time: int, 
                       channel_id: str, message_id: str, event_time: str = None) -> int:
        """Создать сессию мероприятия"""
    ...
    async def start_collect_timer(self, session_id: int, collect_time: int, 
        ...
        """Запустить таймер сбора участников"""
